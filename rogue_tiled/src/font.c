...
void load_font(void)
{
    ...
    font = IMG_Load("rogue_font_tileset/Font.png");
    tiles = IMG_Load("rogue_font_tileset/Tiles.png");
    //font = IMG_Load("rogue_font_tileset/CGA8x8thick.png");
    convert_surface(&font);
    convert_surface(&tiles);
...
void print_tile(SDL_Surface *surface, int x, int y, unsigned char c)
{
    ...
    image_size.x = ((c - TILE_OFFSET) % TILE_COLUMNS) * TILE_WIDTH;
    image_size.y = ((c - TILE_OFFSET) / TILE_COLUMNS) * TILE_HEIGHT;
